  ...
  const projects = [
    {
      ...
      description:
        "Comprehensive AI-powered education platform with live classes, intelligent chatbot, automated exam system, and advanced course management.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Voice/text desktop assistant that performs AI-generated tasks on command.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "GUI app for extracting products, images, and variants from any Shopify store.",
      longDescription:
    ...
    },
    {
      ...
      tech: ["Python"],
      description:
        "Fast command-line tool for scraping Shopify store catalogs.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Animated portfolio showcasing projects, resume, and contact form.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "AI-powered task planner with location-based notifications and smart scheduling.",
      longDescription:
      ...
      image:
        "https://images.pexels.com/photos/5717455/pexels-photo-5717455.jpeg?auto=compress&cs=tinysrgb&w=800",
      link: "#",
      github: "#",
      status: "Ready",
      year: "2024",
    ...
    },
    {
      ...
      description:
        "Digital wellness app with phone locking, usage tracking, and goal setting.",
      longDescription:
      ...
      image:
        "https://images.pexels.com/photos/6238048/pexels-photo-6238048.jpeg?auto=compress&cs=tinysrgb&w=800",
      link: "#",
      github: "#",
      status: "Ready",
      year: "2025",
    ...
    },
    {
      ...
      description:
        "Professional yarn count calculator for various fiber categories with history tracking.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Intelligent chatbot using Retrieval-Augmented Generation for contextual responses.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "AI system for detecting motorcycle riders without helmets and reading number plates.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "AI-powered quality control system for detecting defects in textile fabrics.",
      longDescription:
      ...
      image:
        "https://images.pexels.com/photos/6711867/pexels-photo-6711867.jpeg?auto=compress&cs=tinysrgb&w=800",
      link: "#",
      github: "#",
      status: "Ready",
      year: "2024",
    ...
    },
    {
      ...
      description:
        "Multi-purpose object detection and recognition system with API access.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "AI model predicting tweet virality based on content, timing, user and other metrics.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "AI-powered web application for generating code snippets and full applications.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "AI-powered diagnostic tool for early detection of skin cancer from images.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Comprehensive AI-powered online education platform with live classes and management.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Clean, minimalist portfolio focusing on code quality and technical skills.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Full-featured e-commerce platform with advanced analytics and inventory management.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Comprehensive web-based exam management system with AI-powered grading and automated question parsing.",
      longDescription:
    ...
    {
      id: 21,
      name: "PDF Slip Address Fixer",
      category: "script",
      tech: ["Python", "PyPDF2", "reportlab", "OCR"],
      description:
        "Script to correct address and location fields in bulk product slip PDFs.",
      longDescription:
        "Developed a Python automation script to modify PDF files containing multiple product slips per page. The script detects incorrect address and location fields and replaces them with accurate values across all pages, ensuring data consistency for batch-printed slips.",
      image:
        "https://images.pexels.com/photos/267614/pexels-photo-267614.jpeg?auto=compress&cs=tinysrgb&w=800",
      link: "#",
      github: "#",
      ...
      team: "Solo",
      features: [
        "Bulk PDF parsing and text modification",
        "Detects and corrects wrong addresses",
        "Processes multi-slip layouts (3 per page)",
        "Maintains original formatting and structure",
        "Export-ready corrected PDFs",
      ],
      metrics: {
        pagesProcessed: "100+",
        slipsFixed: "300+",
...

    {
      ...
      description: "Automated bot to apply to jobs on Indeed using Easy Apply.",
      longDescription:
        "Created a Selenium-based automation bot that logs into Indeed, filters relevant job listings, and auto-applies using the Easy Apply feature. It intelligently handles job filters, detects application eligibility, and mimics human behavior to avoid detection.",
      image:
      ...
      team: "Solo",
      features: [
        "Automated login and job filtering",
        "Easy Apply detection and execution",
        "Resumes and prefilled data automation",
        "Custom keyword-based job targeting",
        "Status logging and skip handling",
      ],
      metrics: {
        jobsApplied: "200+",
        timeSaved: "High",
                        ...
                        {filteredProjects.map((project, index) => (
                          ...
                          >
                            <div className="flex items-center justify-between mb-2">
                              <h3 className="font-serif font-medium text-sm leading-tight">
                                {project.name}
                              </h3>
                              <div
                        ...
                        <div className="absolute bottom-0 left-0 p-8">
                          <div className="flex items-center space-x-4 mb-4">
                            ...
                            <span className="text-white/80 text-sm">
                              {filteredProjects[selectedProject].year}
                            </span>
                          </div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {filteredProjects[selectedProject].tech.map(
                              (tech) => (
                                <span
                                  key={tech}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                          <div className="md:col-span-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              {filteredProjects[selectedProject].features.map(
                                (feature, index) => (
                                  <motion.div
                                    key={index}
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                              ...
                              <div className="space-y-4">
                                {Object.entries(
                                  filteredProjects[selectedProject].metrics
                                ).map(([key, value]) => (
                                  <div
                                    key={key}
                            ...
                            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                              ...
                              <div className="space-y-3">
                                ...
                                <div className="flex items-center">
                                  ...
                                  <span className="text-sm">
                                    {filteredProjects[selectedProject].team}
                                  </span>
                                </div>
                              </div>
                            </div>
