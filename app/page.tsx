  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xs sm:text-sm mb-3 sm:mb-4 text-gray-300 font-medium">
          {project.tech}
        </p>
...
export default function Home() {
  ...
  const currentProject =
    displayProjects.length > 0 ? displayProjects[selectedProject] : null;
  ...
  return (
    <>
      <AnimatePresence>
        {shouldShowLoader && <Loader onComplete={handleLoaderComplete} />}
      </AnimatePresence>
      {!shouldShowLoader && (
        <div className="min-h-screen bg-[#0A0A0A] text-[#2C2C2C] p-3 sm:p-4 md:p-6 lg:p-8 flex justify-center items-start sm:items-center relative overflow-x-hidden">
          ...
          >
            ...
            <main className="grid grid-cols-1 xl:grid-cols-12 gap-4 sm:gap-6 md:gap-8">
              ...
              <div className="xl:col-span-8 flex flex-col gap-4 sm:gap-6 md:gap-8">
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-7 gap-4 sm:gap-6 md:gap-8">
                  ...
                  expertise in React, Node.js, and cloud technologies, I turn ideas into scalable digital solutions. */}
                      I'm a full-stack developer and AI engineer passionate
                      about building intelligent, scalable web solutions. With a
                      strong foundation in Python automation, AI-powered web
                      scraping, machine learning, custom scripting, and
                      frameworks like React, Node.js, and Flask, I craft
                      seamless digital experiences that combine smart data
                      extraction with advanced artificial intelligence.
                    </motion.p>
                  </motion.div>{" "}
                  {/* Contact Panel */}
                  <motion.div
              ...
              {/* --- RIGHT COLUMN (PROJECTS + SOCIALS) --- MOBILE OPTIMIZED --- */}
                    ...
                    {displayProjects.map((project, index) => (
                      <div key={project.name} className="w-full">
                        ...
                        <motion.div
                          ...
                          whileHover={{
                            scale: selectedProject === index ? 1 : 1.01,
                          }}
                        >
                          <div className="text-left flex-1 min-w-0">
                            <div className="font-serif text-sm sm:text-sm md:text-base font-medium truncate">
                ...
                >
                  ...
                  <nav className="flex flex-wrap gap-2 sm:gap-3 md:gap-4 lg:gap-6 justify-center">
                    {[
                      ...
                      {
                        name: "LINKEDIN",
                        href: "https://linkedin.com/in/fahaddali",
                      },
                      {
                        name: "TWITTER",
